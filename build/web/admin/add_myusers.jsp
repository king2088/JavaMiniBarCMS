...
<html>
	...
	<body bgcolor="#F2F2F2">
	<div align="center">
	<form name="form1" method="post" action="add_myusers_save.jsp" target="_self">
	...
	<tr>
		...
		<td width="30%"height="39" align="left">&nbsp;&nbsp;<input name="Myuname" type="text" class="input1" id="Myuname" size="20"></td>
		<td height="41" align="right">所供应啤酒的类型：</td>
		<td height="41" align="left">&nbsp;&nbsp;
		  <input name="Pname" type="text" class="input1" id="Pname" size="20"></td>
	  </tr>
	<tr>
	  ...
	  <td height="48" align="left">&nbsp;&nbsp;
	    <input name="Email" type="text" class="input1" size="20"></td>
	  </tr>
	<tr>
	  <td height="39" align="right">手&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;机：</td>
	  <td height="39" align="left">&nbsp;&nbsp;
	    <input name="Tel" type="text" class="input1" id="Tel" size="20"></td>
