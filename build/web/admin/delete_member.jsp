...
<html>
	...
	if (sUserID != null)
	{
		...
		{
			out.println("<p><font color=blue>会员信息删除成功</font></p>");
			out.println("<p><a href=\"show_member_users.jsp?showPage="+strPage+"\" target=\"_self\"><font color=blue>返回员工信息管理</font></a></p>");
		}
		else
		{
			out.println("<p><font color=red>会员信息删除失败，请重试</font></p>");
