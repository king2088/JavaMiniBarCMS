...
<%
	...
	{
		out.println("<p><font color=blue>歌曲删除成功</font></p>");
		out.println("<p><a href=\"music.jsp\" target=\"_self\"><font color=blue>返回歌曲管理</font></a></p>");
	}
	else
	{
		out.println("<p><font color=red>歌曲删除失败，请重试</font></p>");
