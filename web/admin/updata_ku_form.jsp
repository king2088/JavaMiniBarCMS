...
<html>
    ...
    <%
		...
		String sKuid = request.getParameter("kuid");
		long lKuid = Long.parseLong(sKuid);
		Ku.setKuid(lKuid);
		Ku.init();	
	...
	<div align="center">
	<form name="form1" method="post" action="updata_ku_save.jsp" target="_self">
    <input name="kuid" type="hidden" class="input2" value="<%=Ku.getKuid()%>" />
	<table width="100%" border="0" cellpadding="0" cellspacing="0">
    <tr>
		<td height="25" colspan="4" align="center"><h1 style="color:#0F3; font-size:14px">修改产品库存信息</h1>
	    <p style="color: #F00; font-size:12px">以下选项均为必填项，请认真填写，若填写错误，请删查误信息后重新修改！</p></td>
	  </tr>
	<tr>
		<td width="13%"height="39" align="right">产品名称：</td>
		<td width="30%"height="39" align="left">&nbsp;&nbsp;<input name="goodname" type="text" class="input1" id="goodname" value="<%=Ku.getGoodname()%>" size="20"></td>
		<td width="20%"height="39" align="right">库存数量：</td>
		<td width="37%"height="39" align="left">&nbsp;&nbsp;<input name="num" type="text" class="input1" id="num" value="<%=Ku.getNum()%>" size="20"></td>
	</tr>
	<tr>
